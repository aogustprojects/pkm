                ...
                @endif
                  <div class="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                      <div class="relative w-full">
                          ...
                          <input class="block p-3 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:rounded-none sm:rounded-l-lg focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Cari Postingan" name="search" type="search" id="search" autocomplete="off">
                      </div>
                      <div>
      ...
      <div class="py-4 px-4 mx-auto max-w-screen-xl lg:py-8 lg:px-0">
          <div class="grid gap-8 lg:grid-cols-3 md:grid-cols-2">       
            @forelse ($postingan as $post)
                ...
                <div class="flex justify-between items-center py-5  text-gray-8 00">
                  ...
                  <div class="mt-auto flex justify-between items-center">
                    <a href="/postingan?author={{ $post->author->username }}">
                      ...
                      <a href="/postingan/{{ $post->slug }}" class="text-sm inline-flex items-center font-medium text-primary-600 dark:text-primary-500 hover:underline">
                          Selengkapnya
              ...
              @empty
              <div>
                <p class="font-semibold text-xl my-4">Postingan tidak ditemukan</p>
                <a href="/postingan" class="block text-blue-600 hover:underline">&laquo; Kembali ke Postingan</a>
              </div>
            @endforelse
          </div>  
      </div>
