...
@endif
    <div class="mb-5 mt-5 flex justify-between">
        <h1 class="block mb-2 text-4xl font-bold text-gray-900 dark:text-white">Tambah Surat Masuk</h1>
    ...
    <hr>
    <form class="w-full mt-5" enctype="multipart/form-data" method="POST" action="/dashboard/arsip_surat_masuk">
        @csrf
        <div class="mb-5 flex space-x-4">
            ...
            <div class="w-1/2">
                ...
                <input type="date" id="tanggal_terima" name="tanggal_terima" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required autofocus value="{{ old('tanggal_terima') }}"/>
            </div>
