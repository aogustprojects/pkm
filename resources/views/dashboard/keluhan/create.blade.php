                ...
                <div class="relative flex h-full flex-col overflow-hidden rounded-xl bg-white">
                    <div class="px-8 py-8 sm:px-10 sm:pt-10">
                        <div class="flex justify-between items-center mb-6">
                            <p class="text-2xl font-semibold tracking-tight text-gray-900 max-lg:text-center">Tambah Keluhan</p>
                        </div>
                                ...
                                <div class="sm:col-span-1">
                                    ...
                                    <div class="mt-2">
                                        <select name="asal_keluhan" id="asal_keluhan" class="mt-2 block w-full rounded-md border-0 py-1.5 pl-3 pr-10 text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-indigo-600 sm:text-sm sm:leading-6 @error('asal_keluhan') border-red-500 @enderror">
                                            ...
                                            <option value="whatsapp" {{ old('asal_keluhan') == 'whatsapp' ? 'selected' : '' }}>WhatsApp</option>
                                            <option value="instagram" {{ old('asal_keluhan') == 'instagram' ? 'selected' : '' }}>Instagram</option>
                                            <option value="email" {{ old('asal_keluhan') == 'email' ? 'selected' : '' }}>Email</option>
                                            <option value="google_review" {{ old('asal_keluhan') == 'google_review' ? 'selected' : '' }}>Google Review</option>
                                        </select>
                                        @error('asal_keluhan')
