            ...
            <div class="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] max-lg:rounded-t-[calc(2rem+1px)]">
              <div class="px-8 py-8 sm:px-10 sm:pt-10">
                ...
                <div class="flex justify-between mb-5">
                  <p class="mt-2 mb-2 text-lg font-medium tracking-tight text-gray-950 max-lg:text-center">List Surat Keluar</p>
                  <form action="{{ route('arsip_surat_keluar.index') }}" method="GET" class="flex items-center max-w-sm mx-auto">   
                  ...
                  <a href="/dashboard/arsip_surat_keluar/create" class="bg-blue-700 rounded-lg px-2 py-3 text-sm text-white hover:bg-blue-900 hover:text-white">Tambah Surat Keluar</a>
                </div>
                  ...
                  <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                      <tr>
                        ...
                        <th scope="col" class="px-6 py-3 text-center">Dikirim Ke</th>
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                          ...
                          <td class="px-6 py-4 text-center">
                            <div class="flex justify-center items-center space-x-2">
                                <a href="{{ route('arsip_surat_keluar.show', $surat->id) }}">
                                    <span>
                                ...
                                <a href="/dashboard/arsip_surat_keluar/{{ $surat->id }}/edit">
                                    <span>
