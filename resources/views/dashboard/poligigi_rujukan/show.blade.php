        ...
        <form class="px-4 mx-auto mt-4 space-y-2" id="rujukan-form" method="POST" action="/poli-gigi-rujukan">
            ...
            <div class="flex w-full gap-2">
                <div class="flex w-full">
                    ...
                    <input type="text" id="name_copy" value="{{ $poliGigiRujukan->name }}" readonly class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-e-md border border-gray-300" readonly />
                </div>
            </div>
            <div class="flex w-full gap-2">
                <div class="flex w-full">
